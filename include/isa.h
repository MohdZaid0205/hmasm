...
#define SIGNATURE_MISS_MATCH_WARNING(inst_name, body)                           \
    WARNING(ISA_ISM_DES, {                                                      \
        WARNING_LN(INSET, ISA_ISM_LN1);                                         \
        INFORMATION_LN(INSET, ISA_ISM_LN2);                                     \
        { body }                                                                \
        WARNING_EN(ISA_ISM_END, #inst_name);                                    \
    }, #inst_name)

#define OTHERWISE(inst_name, body) \
    else { SIGNATURE_MISS_MATCH_WARNING(inst_name, body); }
